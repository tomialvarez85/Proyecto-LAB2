    ...
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          fontWeight: '800',
          marginBottom: screenSize === 'mobile' ? '8px' : screenSize === 'tablet' ? '10px' : '12px',
        ...
        <p style={{
          ...
          color: '#555',
          marginBottom: screenSize === 'mobile' ? '12px' : screenSize === 'tablet' ? '15px' : '18px',
          lineHeight: '1.6'
        }}>
          Únete a nuestra comunidad de jugadores de padel
        </p>

        {/* Formulario */}
        <form onSubmit={handleSubmit} style={{ textAlign: 'left' }}>
          <div style={{ marginBottom: screenSize === 'mobile' ? '10px' : screenSize === 'tablet' ? '12px' : '15px' }}>
            <label style={{
              display: 'block',
              marginBottom: screenSize === 'mobile' ? '4px' : screenSize === 'tablet' ? '5px' : '6px',
              fontWeight: '600',
              color: '#333',
          ...
          <button
            ...
            style={{
              ...
              transition: 'all 0.3s ease',
              marginBottom: screenSize === 'mobile' ? '10px' : screenSize === 'tablet' ? '12px' : '15px',
              boxShadow: loading 
                ? 'none' 
...
export default RegisterFormResponsive;
